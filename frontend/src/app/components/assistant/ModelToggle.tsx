...
export interface ModelOption {
    id: string;
    label: string;
    group: "Anthropic" | "Google" | "OpenAI" | "Amazon Bedrock";
}
...
export const MODELS: ModelOption[] = [
    ...
    { id: "amazon-bedrock/claude-fable-5", label: "Claude Fable 5 (Bedrock)", group: "Amazon Bedrock" },
    { id: "amazon-bedrock/claude-opus-4-8", label: "Claude Opus 4.8 (Bedrock)", group: "Amazon Bedrock" },
...
const GROUP_ORDER: ModelOption["group"][] = ["Anthropic", "Google", "OpenAI", "Amazon Bedrock"];
